...
/**
 * Class MP_Debug_Test_Block_View_Sidebar
 *
 * @category MP
 * @package  MP_Debug
 ...
 *
 * @covers MP_Debug_Block_View_Sidebar
 * @codeCoverageIgnore
 */
class MP_Debug_Test_Block_View_Sidebar extends EcomDev_PHPUnit_Test_Case
{

    public function testGetHttpMethodOptions()
    {
        $helper = $this->getHelperMock('mp_debug/filter', array('getHttpMethodValues'));
        ...
        $block = $this->getBlockMock('mp_debug/view_sidebar', array('getOptionArray'));
    ...
    public function testGetHttpMethodsSelect()
    {
        ...
        $block = $this->getBlockMock('mp_debug/view_sidebar', array('getHttpMethodOptions', 'getLayout', 'getRequest'));
    ...
    public function testGetLimitOptionsSelect()
    {
        ...
        $block = $this->getBlockMock('mp_debug/view_sidebar', array('getOptionArray', 'getLayout', 'getRequest'));
