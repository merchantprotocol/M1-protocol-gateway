...
/**
 * Class MP_Debug_Test_Block_View
 *
 * @category MP
 * @package  MP_Debug
 ...
 *
 * @covers MP_Debug_Block_View
 * @codeCoverageIgnore
 */
class MP_Debug_Test_Block_View extends EcomDev_PHPUnit_Test_Case
{

    public function testGetRequestInfo()
    {
        $this->replaceRegistry('mp_debug_request_info', 'registry data');
        $block = $this->getBlockMock('mp_debug/view', array('toHtml'));
    ...
    public function testGetService()
    {
        ...
        $this->assertNotNull($actual);
        $this->assertInstanceOf('MP_Debug_Model_Service', $actual);
    }
    ...
    public function testGetFilteredRequestListUrl()
    {
        ...
        $helper = $this->getHelperMock('mp_debug/filter', array('getRequestFilters'));
        $helper->expects($this->once())->method('getRequestFilters')
            ->with($request)
            ->willReturn(array('method' => 'post'));
        $this->replaceByMock('helper', 'mp_debug/filter', $helper);

        $block = $this->getBlockMock('mp_debug/view', array('getRequest', 'getRequestListUrl'));
    ...
    {
        $block = $this->getBlockMock('mp_debug/view', array('toHtml', 'renderValue'));
    ...
    {
        $array = array(1, 2, 4);
        $childBlock = $this->getBlockMock('mp_debug/view', array('setTemplate', 'setData', '_toHtml'));
        $childBlock->expects($this->once())->method('setTemplate')->with('mp_debug/view/panel/_array.phtml')->willReturnSelf();
        ...
        $layout->expects($this->once())->method('createBlock')->with('mp_debug/view')->willReturn($childBlock);

        $block = $this->getBlockMock('mp_debug/view', array('getLayout'));
    ...
    public function testRenderArrayFields()
    {
        ...
        $childBlock = $this->getBlockMock('mp_debug/view', array('setTemplate', 'setData', '_toHtml'));
        $childBlock->expects($this->once())->method('setTemplate')->with('mp_debug/view/panel/_array_fields.phtml');
    ...
    {
        $block = $this->getBlockMock('mp_debug/view', array('escapeHtml'));
    ...
    public function testRenderValueForArray()
    {
        ...
        $block = $this->getBlockMock('mp_debug/view', array('getLayout', 'renderArray'));
    ...
    public function testRenderValueForObject()
    {
        ...
        $block = $this->getBlockMock('mp_debug/view', array('getLayout', 'escapeHtml'));
    ...
    {
        $rootBlock = $this->getModelMock('mp_debug/block',
        ...
        $headBlock = $this->getModelMock('mp_debug/block',
            array('getParentName', 'getName', 'getClass', 'getTemplateFile', 'getRenderedDuration', 'getRenderedCount'));
        ...
        $gaBlock = $this->getModelMock('mp_debug/block',
            array('getParentName', 'getName', 'getClass', 'getTemplateFile', 'getRenderedDuration', 'getRenderedCount'));
        ...
        $formKeyBlock = $this->getModelMock('mp_debug/block',
            array('getParentName', 'getName', 'getClass', 'getTemplateFile', 'getRenderedDuration', 'getRenderedCount'));
        ...
        $requestInfo = $this->getModelMock('mp_debug/requestInfo', array('getBlocks'));
        $requestInfo->expects($this->any())->method('getBlocks')->willReturn(array($rootBlock, $headBlock, $gaBlock, $formKeyBlock));

        $block = $this->getBlockMock('mp_debug/view', array('getLayout', 'getRequestInfo'));
    ...
    public function testGetBlockTreeHtml()
    {
        ...
        $block = $this->getBlockMock('mp_debug/view', array('getBlocksAsTree', 'renderTreeNode'));
    ...
    public function testRenderTreeNode()
    {
        ...
        $nodeBlock = $this->getBlockMock('mp_debug/view', array('setRequestInfo', 'setTemplate', 'setNode', 'setIndent', '_toHtml'));
        $nodeBlock->expects($this->once())->method('setRequestInfo')->with($requestInfo);
        $nodeBlock->expects($this->once())->method('setTemplate')->with('mp_debug/view/panel/_block_node.phtml');
