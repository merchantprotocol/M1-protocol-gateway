...
/**
 * Class MP_Debug_Test_Model_Controller
 *
 * @covers MP_Debug_Model_Controller
 * @codeCoverageIgnore
 */
class MP_Debug_Test_Model_Controller extends EcomDev_PHPUnit_Test_Case
{
    ...
    public function testConstruct()
    {
        ...
        $this->assertInstanceOf('MP_Debug_Model_Controller', $controller);
    }
    ...
    public function testInit()
    {
        ...
        $helperMock = $this->getHelperMock('mp_debug', array('getAllHeaders', 'getGlobalServer', 'getGlobalSession', 'getGlobalPost', 'getGlobalGet', 'getGlobalCookie'));
        ...
        /** @var MP_Debug_Model_Controller $model */
        $model = Mage::getModel('mp_debug/controller');
        $model->init($action);

        $this->assertNotFalse($model);
        $this->assertInstanceOf('MP_Debug_Model_Controller', $model);
    ...
    public function testAddResponseInfo()
    {
        ...
        /** @var MP_Debug_Model_Controller $model */
        $model = $this->getModelMock('mp_debug/controller', array('getRequestPath'), false, array(), '', false);
    ...
    {
        /** @var MP_Debug_Model_Controller $model */
        $model = $this->getModelMock('mp_debug/controller', array('getClass', 'getAction'), false, array(), '', false);
    ...
    {
        /** @var MP_Debug_Model_Controller $model */
        $model = $this->getModelMock('mp_debug/controller', array('getReference'), false, array(), '', false);
