...
/**
 * Class MP_Debug_Test_Model_Core_Email_Template
 *
 * @category MP
 * @package  MP_Debug
 ...
 *
 * @covers MP_Debug_Model_Core_Email_Template
 * @codeCoverageIgnore
 */
class MP_Debug_Test_Model_Core_Email_Template extends EcomDev_PHPUnit_Test_Case
{
    ...
    public function testRewrite()
    {
        ...
        $this->assertInstanceOf('MP_Debug_Model_Core_Email_Template', $model);
    }


    /**
     * @covers MP_Debug_Model_Core_Email_Template_Capture::send
     */
    public function testSend()
    {
        ...
        $model->expects($this->once())->method('parentSend')
            ->with('mario@mailinator.com', 'Mario', array('store' => 'Pirate MP'))
            ->willReturn(true);
        $model->expects($this->once())->method('addEmailToProfile')->with(
            'mario@mailinator.com',
            'Mario',
            array('store' => 'Pirate MP'),
            true,
            $mail
        );

        $model->send('mario@mailinator.com', 'Mario', array('store' => 'Pirate MP'));
    }
    ...
    public function testSendWithException()
    {
        ...
        $actual = $model->send('mario@mailinator.com', 'Mario', array('store' => 'Pirate MP'));
        $this->assertTrue($actual);
    }


    /**
     * @covers MP_Debug_Model_Core_Email_Template_Capture::addEmailToProfile
     */
    public function testAddEmailToProfile()
    {
        ...
        $emailMock->expects($this->once())->method('setVariables')->with(array('store' => 'Pirate MP'));
        ...
        $model->addEmailToProfile('mario@mailinator.com', 'Mario', array('store' => 'Pirate MP'), true, $mail);
    }


    /**
     * @covers MP_Debug_Model_Core_Email_Template_Capture::getContent
     */
    ...
    /**
     * @covers MP_Debug_Model_Core_Email_Template_Capture::getPartDecodedContent
     */
    ...
    /**
     * @covers MP_Debug_Model_Core_Email_Template_Capture::decodeSubject
     */
