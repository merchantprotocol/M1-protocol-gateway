...
/**
 * Class MP_Debug_Test_Model_RequestInfo
 *
 * @covers MP_Debug_Model_RequestInfo
 * @codeCoverageIgnore
 */
class MP_Debug_Test_Model_RequestInfo extends EcomDev_PHPUnit_Test_Case
{
    ...
    {
        $this->model = Mage::getModel('mp_debug/requestInfo');
    }

    public function testConstruct()
    {
        $this->assertNotFalse($this->model);
        $this->assertInstanceOf('MP_Debug_Model_RequestInfo', $this->model);
        $this->assertEquals('mp_debug/requestInfo', $this->model->getResourceName());
        $this->assertNotNull($this->model->getDesign());
        $this->assertInstanceOf('MP_Debug_Model_Design', $this->model->getDesign());
    }


    /**
     * @covers MP_Debug_Model_Resource_RequestInfo
     */
    public function testResource()
    {
        $resourceModel = $this->model->getResource();
        $this->assertNotFalse($resourceModel);
        $this->assertInstanceOf('MP_Debug_Model_Resource_RequestInfo', $resourceModel);
        $this->assertEquals('mp_debug_request_info', $resourceModel->getMainTable());
        $this->assertEquals('id', $resourceModel->getIdFieldName());
    }


    /**
     * @covers MP_Debug_Model_Resource_RequestInfo_Collection
     */
    public function testCollection()
    {
        $collection = $this->model->getCollection();
        $this->assertNotFalse($collection);
        $this->assertInstanceOf('MP_Debug_Model_Resource_RequestInfo_Collection', $collection);
        $this->assertEquals('mp_debug/requestInfo', $collection->getResourceModelName());
    }


    public function testInitLogging()
    {
        $helper = $this->getHelperMock('mp_debug', array('getLogFilename', 'getExceptionLogFilename'));
        ...
        $logging = $this->getModelMock('mp_debug/logging', array('addFile', 'startRequest'));
        $this->replaceByMock('model', 'mp_debug/logging', $logging);
        ...
        $this->assertEventDispatched('mp_debug_init_logging');
    }
    ...
    {
        $this->model->addEmail(Mage::getModel('mp_debug/email'));
    ...
    public function testAddControllerAction()
    {
        ...
        $controllerMock = $this->getModelMock('mp_debug/controller', array('init'));
        $controllerMock->expects($this->once())->method('init')->with($action);
        $this->replaceByMock('model', 'mp_debug/controller', $controllerMock);

        $this->model->addControllerAction($action);

        $actual = $this->model->getController();
        $this->assertNotNull($actual);
        $this->assertInstanceOf('MP_Debug_Model_Controller', $actual);
    }
    ...
    public function testAddLayout()
    {
        ...
        $design = $this->getModelMock('mp_debug/design', array('init'));
        $design->expects($this->once())->method('init')->with($layout, $designPackage);

        $model = $this->getModelMock('mp_debug/requestInfo', array('getDesign'));
    ...
    {
        $b1 = $this->getModelMock('mp_debug/block',
        ...
        $model = $this->getModelMock('mp_debug/requestInfo', array('getBlocks'));
    ...
    {
        $collectionMock = $this->getModelMock('mp_debug/collection', array('incrementCount', 'init', 'getClass'));
        ...
        $this->replaceByMock('model', 'mp_debug/collection', $collectionMock);
    ...
    {
        $col1 = $this->getModelMock('mp_debug/collection', array('getType', 'getClass', 'getQuery', 'getCount'));
        ...
        $col2 = $this->getModelMock('mp_debug/collection', array('getType', 'getClass', 'getQuery', 'getCount'));
        ...
        $model = $this->getModelMock('mp_debug/requestInfo', array('getCollections'));
    ...
    {
        $modelMock = $this->getModelMock('mp_debug/model', array('init', 'getClass', 'incrementCount'));
        ...
        $this->replaceByMock('model', 'mp_debug/model', $modelMock);
    ...
    {
        $model1 = $this->getModelMock('mp_debug/model', array('getResource', 'getClass', 'getCount'));
        ...
        $model2 = $this->getModelMock('mp_debug/model', array('getResource', 'getClass', 'getCount'));
        ...
        $model = $this->getModelMock('mp_debug/requestInfo', array('getModels'));
    ...
    {
        $profilerMock = $this->getMock('MP_Debug_Model_Db_Profiler', array('getEnabled', 'getQueryModels', 'getTotalNumQueries', 'getTotalElapsedSecs'));
        ...
        $helperMock = $this->getHelperMock('mp_debug', array('getSqlProfiler'));
        $helperMock->expects($this->any())->method('getSqlProfiler')->willReturn($profilerMock);
        $this->replaceByMock('helper', 'mp_debug', $helperMock);

        $model = $this->getModelMock('mp_debug/requestInfo', array('setQueryCount', 'setQueryTime'));
    ...
    {
        $helper = $this->getHelperMock('mp_debug', array('getMemoryUsage'));
    ...
    {
        $helper = $this->getHelperMock('mp_debug', array('getCurrentScriptDuration'));
    ...
    {
        MP_Debug_Model_Block::$endRenderingTime = 0.90;
        MP_Debug_Model_Block::$startRenderingTime = 0.75;
    ...
    {
        $controller = $this->getModelMock('mp_debug/controller', array('getSessionId'));
        $controller->expects($this->any())->method('getSessionId')->willReturn(12345);

        $model = $this->getModelMock('mp_debug/requestInfo', array('getController'));
    ...
    {
        $model = $this->getModelMock('mp_debug/requestInfo',
    ...
    {
        $model = $this->getModelMock('mp_debug/requestInfo', array('getInfo'));
    ...
    public function testGetAbsoluteUrl()
    {
        ...
        $model = $this->getModelMock('mp_debug/requestInfo', array('getStoreId', 'getRequestPath'));
    ...
    {
        $controller = $this->getModelMock('mp_debug/controller',
        ...
        $this->assertEventDispatched('mp_debug_requestInfo_save_before');
    }
    ...
    public function testAfterLoad()
    {
        ...
        $model = $this->getModelMock('mp_debug/requestInfo', array('getUnserializedInfo'));
        ...
        $this->assertEventDispatched('mp_debug_requestInfo_load_after');
    ...
    /**
     * @covers MP_Debug_Model_Resource_RequestInfo_Collection::addSessionIdFilter
     */
    public function testAddSessionIdFilter()
    {
        $collection = $this->getResourceModelMock('mp_debug/requestInfo_collection', array('addFieldToFilter'));
        $this->replaceByMock('resource_model', 'mp_debug/requestInfo_collection', $collection);
    ...
    /**
     * @covers MP_Debug_Model_Resource_RequestInfo_Collection::addTokenFilter
     */
    ...
    /**
     * @covers MP_Debug_Model_Resource_RequestInfo_Collection::addHttpMethodFilter
     */
    ...
    /**
     * @covers MP_Debug_Model_Resource_RequestInfo_Collection::addRequestPathFilter
     */
    ...
    /**
     * @covers MP_Debug_Model_Resource_RequestInfo_Collection::addResponseCodeFilter
     */
    ...
    /**
     * @covers MP_Debug_Model_Resource_RequestInfo_Collection::addIpFilter
     */
    ...
    /**
     * @covers MP_Debug_Model_Resource_RequestInfo_Collection::addEarlierFilter
     */
    ...
    /**
     * @covers MP_Debug_Model_Resource_RequestInfo_Collection::addAfterFilter
     */
