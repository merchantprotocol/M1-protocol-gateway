...
/**
 * Class MP_Debug_Test_Model_Cron
 *
 * @category MP
 ...
 *
 * @covers MP_Debug_Model_Cron
 * @codeCoverageIgnore
 */
class MP_Debug_Test_Model_Cron extends EcomDev_PHPUnit_Test_Case
{

    public function testDeleteExpiredRequestsForDisabledModule()
    {
        $helperMock = $this->getHelperMock('mp_debug', array('isEnabled', 'getPersistLifetime'));
        ...
        $model = Mage::getModel('mp_debug/cron');
    ...
    public function testDeleteExpiredRequests()
    {
        ...
        $model = $this->getModelMock('mp_debug/cron', array('getExpirationDate', 'getRequestsTable'));
    ...
    {
        $helperMock = $this->getHelperMock('mp_debug', array('getPersistLifetime'));
        $this->replaceByMock('helper', 'mp_debug', $helperMock);
