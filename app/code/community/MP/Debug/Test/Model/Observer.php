...
/**
 * Class MP_Debug_Test_Model_Observer
 *
 * @category MP
 ...
 *
 * @covers MP_Debug_Model_Observer
 * @codeCoverageIgnore
 */
class MP_Debug_Test_Model_Observer extends EcomDev_PHPUnit_Test_Case
{

    public function testConstruct()
    {
        $model = Mage::getModel('mp_debug/observer');
        $this->assertNotFalse($model);
        $this->assertInstanceOf('MP_Debug_Model_Observer', $model);
        ...
        $this->assertInstanceOf('MP_Debug_Model_RequestInfo', $requestInfo);
    ...
    {
        $helper = $this->getHelperMock('mp_debug', array('canCapture', 'canEnableVarienProfiler'));
        ...
        $requestInfo = $this->getModelMock('mp_debug/requestInfo', array('setIsStarted', 'setStoreId', 'setDate', 'initLogging'));
        ...
        $model = $this->getModelMock('mp_debug/observer', array('getCurrentStore', 'canCollect', 'getRequestInfo', 'registerShutdown'));
    ...
    {
        $helper = $this->getHelperMock('mp_debug', array('getMemoryUsage', 'getCurrentScriptDuration'));
        ...
        MP_Debug_Model_Block::$startRenderingTime = 0.70;
        MP_Debug_Model_Block::$endRenderingTime = 0.90;

        $requestInfo = $this->getModelMock('mp_debug/requestInfo',
        ...
        $model = $this->getModelMock('mp_debug/observer', array('getRequestInfo'));
        $model->expects($this->any())->method('getRequestInfo')->willReturn($requestInfo);
    ...
    {
        $requestInfo = $this->getModelMock('mp_debug/requestInfo', array('getIsStarted'));
        $requestInfo->expects($this->any())->method('getIsStarted')->willReturn(true);

        $model = $this->getModelMock('mp_debug/observer', array('getRequestInfo', 'updateProfiling', 'saveProfiling'));
        $model->expects($this->any())->method('getRequestInfo')->willReturn($requestInfo);
    ...
    {
        $helper = $this->getHelperMock('mp_debug', array('canPersist'));
        $helper->expects($this->once())->method('canPersist')->willReturn(true);
        $this->replaceByMock('helper', 'mp_debug', $helper);


        $requestInfo = $this->getModelMock('mp_debug/requestInfo', array('getIsStarted', 'save'));
        $requestInfo->expects($this->any())->method('getIsStarted')->willReturn(true);
        $requestInfo->expects($this->once())->method('save');

        $model = $this->getModelMock('mp_debug/observer', array('canCollect', 'getRequestInfo'));
        $model->expects($this->any())->method('canCollect')->willReturn(true);
        $model->expects($this->any())->method('getRequestInfo')->willReturn($requestInfo);
    ...
    {
        $model = $this->getModelMock('mp_debug/observer', array('startProfiling'));
    ...
    public function testOnActionPreDispatch()
    {
        ...
        $requestInfo = $this->getModelMock('mp_debug/requestInfo', array('addControllerAction'));
    ...
    public function testOnLayoutGenerate()
    {
        ...
        $requestInfo = $this->getModelMock('mp_debug/requestInfo', array('addBlock', 'addLayout'));
        ...
        $model = $this->getModelMock('mp_debug/observer', array('canCollect', 'getRequestInfo', 'canCaptureBlock', 'saveProfiling'));
        $model->expects($this->any())->method('canCollect')->willReturn(true);
        $model->expects($this->any())->method('getRequestInfo')->willReturn($requestInfo);
    ...
    public function testOnBlockToHtml()
    {
        ...
        $blockInfo = $this->getModelMock('mp_debug/block', array('startRendering'));
        $blockInfo->expects($this->once())->method('startRendering');

        $requestInfo = $this->getModelMock('mp_debug/requestInfo', array('getBlock', 'addBlock'));
        ...
        $model = $this->getModelMock('mp_debug/observer', array('canCollect', 'getRequestInfo', 'canCaptureBlock', 'updateProfiling'));
        $model->expects($this->any())->method('canCollect')->willReturn(true);
        $model->expects($this->any())->method('getRequestInfo')->willReturn($requestInfo);
    ...
    public function testOnBlockToHtmlAfter()
    {
        ...
        $blockInfo = $this->getModelMock('mp_debug/block', array('completeRendering'));
        $blockInfo->expects($this->once())->method('completeRendering');

        $requestInfo = $this->getModelMock('mp_debug/requestInfo', array('getBlock'));
        $requestInfo->expects($this->once())->method('getBlock')->with('product.info')->willReturn($blockInfo);
    ...
    public function testOnCollectionLoad()
    {
        ...
        $requestInfo = $this->getModelMock('mp_debug/requestInfo', array('addCollection'));
    ...
    public function testOnModelLoad()
    {
        ...
        $requestInfo = $this->getModelMock('mp_debug/requestInfo', array('addModel'));
    ...
    public function testOnControllerFrontSendResponseAfter()
    {
        ...
        $controller = $this->getModelMock('mp_debug/controller', array('addResponseInfo'));
        ...
        $model = $this->getModelMock('mp_debug/observer', array('canCollect', 'getRequestInfo', 'updateProfiling'));
        $model->expects($this->any())->method('canCollect')->willReturn(true);
        $model->expects($this->any())->method('getRequestInfo')->willReturn($requestInfo);
        $model->expects($this->once())->method('updateProfiling');
    ...
    {
        $this->assertTrue(Mage::getModel('mp_debug/observer')->canCaptureCoreBlocks());
    }


    public function testCanCaptureBlock()
    {
        $block = $this->getBlockMock('mp_debug/toolbar');
    ...
    {
        $model = $this->getModelMock('mp_debug/observer', array('canCaptureCoreBlocks'));
