 ...
 */
trait MP_Debug_Model_Core_Email_Template_Capture
{
...
if (Mage::helper('core')->isModuleEnabled('Aschroder_SMTPPro')) {
    ...
    class MP_Debug_Model_Core_Email_Template extends Aschroder_SMTPPro_Model_Email_Template
    {
        use MP_Debug_Model_Core_Email_Template_Capture;
    }

} else if(Mage::helper('core')->isModuleEnabled('Ebizmarts_Mandrill')) {


    class MP_Debug_Model_Core_Email_Template extends Ebizmarts_Mandrill_Model_Email_Template
    {
        use MP_Debug_Model_Core_Email_Template_Capture;
    }
    ...
    class MP_Debug_Model_Core_Email_Template extends Mage_Core_Model_Email_Template
    {
        use MP_Debug_Model_Core_Email_Template_Capture;
    }
}
