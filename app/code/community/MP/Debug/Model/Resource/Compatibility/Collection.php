...
/**
 * Class MP_Debug_Model_Resource_Compatibility_Collection
 *
 * @category MP
 * @package  MP_Debug
 ...
 */
class MP_Debug_Model_Resource_Compatibility_Collection extends MP_Debug_Model_Resource_NonDbCollection
{
	/**
	 * (non-PHPdoc)
