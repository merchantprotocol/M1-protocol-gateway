...
/**
 * Class MP_Debug_Model_RequestInfo
 *
 * @method boolean getIsStarted()
 * @method void setIsStarted(boolean $value)
 * @method string getToken()
 * @method MP_Debug_Model_RequestInfo setToken(string $value)
 * @method string getHttpMethod()
 * @method MP_Debug_Model_RequestInfo setHttpMethod(string $value)
 * @method int getStoreId()
 * @method MP_Debug_Model_RequestInfo setStoreId(int $value)
 * @method string getRequestPath()
 * @method MP_Debug_Model_RequestInfo setRequestPath(string $value)
 * @method int getResponseCode()
 * @method MP_Debug_Model_RequestInfo setResponseCode(int $value)
 * @method string getIp()
 * @method MP_Debug_Model_RequestInfo setIp(string $value)
 * @method string getSessionId()
 * @method MP_Debug_Model_RequestInfo setSessionId(string $value)
 * @method string getDate()
 * @method MP_Debug_Model_RequestInfo setDate(string $value)
 * @method MP_Debug_Model_RequestInfo setRenderingTime(float $value)
 * @method float getQueryTime()
 * @method MP_Debug_Model_RequestInfo setQueryTime(float $value)
 * @method int getQueryCount()
 * @method MP_Debug_Model_RequestInfo setQueryCount(int $value)
 * @method MP_Debug_Model_RequestInfo setTime(float $value)
 * @method MP_Debug_Model_RequestInfo setPeakMemory(int $value)
 * @method  getInfo()
 * @method MP_Debug_Model_RequestInfo setInfo($value)
 */
class MP_Debug_Model_RequestInfo extends Mage_Core_Model_Abstract
{
    /** @var MP_Debug_Model_Logging */
    protected $logging;

    /** @var MP_Debug_Model_Controller */
    protected $action;

    /** @var MP_Debug_Model_Design */
    protected $design;

    /** @var MP_Debug_Model_Block[] */
    protected $blocks = array();

    /** @var MP_Debug_Model_Model[] */
    protected $models = array();

    /** @var MP_Debug_Model_Collection[] */
    ...
    public function initLogging()
    {
        ...
        $this->logging = Mage::getModel('mp_debug/logging');
        ...
        Mage::dispatchEvent('mp_debug_init_logging', array('logging' => $this->logging));
     ...
     *
     * @param MP_Debug_Model_Email $email
     */
    public function addEmail(MP_Debug_Model_Email $email)
    {
        $this->emails[] = $email;
    }
    ...
    {
        $controller = Mage::getModel('mp_debug/controller');
     ...
     * @return MP_Debug_Model_Block
     */
    public function addBlock(Mage_Core_Block_Abstract $block)
    {
        $blockInfo = Mage::getModel('mp_debug/block');
    ...
    {
        $info = Mage::getModel('mp_debug/collection');
     ...
     *
     * @return MP_Debug_Model_Collection[]
     */
    ...
    {
        $modelInfo = Mage::getModel('mp_debug/model');
    ...
    public function initQueries()
    {
        ...
        $profiler = Mage::helper('mp_debug')->getSqlProfiler();
        if ($profiler->getEnabled() && $profiler instanceof MP_Debug_Model_Db_Profiler) {
    ...
    {
        return $this->hasData('time') ? $this->getData('time') : Mage::helper('mp_debug')->getCurrentScriptDuration();
    }
    ...
    {
        return $this->hasData('rendering_time') ? $this->getData('rendering_time') : MP_Debug_Model_Block::getTotalRenderingTime();
    }


    protected $_eventPrefix = 'mp_debug_requestInfo';


    protected function _construct()
    {
        $this->_init('mp_debug/requestInfo');
        $this->design = Mage::getModel('mp_debug/design');
    }
