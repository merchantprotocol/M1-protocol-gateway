...
/**
 * Class MP_Debug_Helper_Url
 */
class MP_Debug_Helper_Url extends Mage_Core_Helper_Data
{
    const MODULE_ROUTE = 'mp_debug/';
     ...
     *
     * @see \MP_Debug_IndexController::searchAction
     * @param array $filters
     * @return string
     */
     ...
     *
     * @see \MP_Debug_IndexController::latestAction
     * @param string $panel
     * @return string
     */
     ...
     *
     * @see \MP_Debug_IndexController::viewAction
     * @param $token
     * @param string $panel
     * @return string
     */
     ...
     *
     * @see \MP_Debug_ModuleController::enableAction
     ...
     *
     * @see \MP_Debug_ModuleController::disableAction
     * @param string $moduleName
     * @return string
     */
     ...
     *
     * @see \MP_Debug_ModelController::enableSqlProfilerAction
     * @return string
     */
     ...
     *
     * @see \MP_Debug_ModelController::disableSqlProfilerAction
     * @return string
     */
     ...
     *
     * @see \MP_Debug_ModelController::selectSqlAction
     * @param string $token
     * @param int $index
     * @return string
     */
     ...
     *
     * @see \MP_Debug_ModelController::describeSqlAction
     * @param string $token
     * @param int $index
     * @return string
     */
     ...
     *
     * @see \MP_Debug_ModelController::stacktraceSqlAction
     * @param string $token
     * @param int $index
     * @return string
     */
     ...
     *
     * @see \MP_Debug_DesignController::layoutUpdatesAction
     * @param string $token
     * @return string
     */
     ...
     *
     * @see \MP_Debug_IndexController::viewLogAction
     * @param string $token
     ...
     *
     * @see \MP_Debug_IndexController::purgeProfilesAction
     * @return string
     */
     ...
     *
     * @see \MP_Debug_UtilController::searchGroupClassAction
     * @return string
     */
     ...
     *
     * @see \MP_Debug_UtilController::flushCacheAction
     * @return string
     */
     ...
     *
     * @see \MP_Debug_UtilController::enableTemplateHintsAction
     * @return string
     */
     ...
     *
     * @see \MP_Debug_UtilController::disableTemplateHintsAction
     * @return string
     */
     ...
     *
     * @see \MP_Debug_UtilController::enableFPCDebugAction
     * @return string
     */
     ...
     *
     * @see \MP_Debug_UtilController::disableFPCDebugAction
     * @return string
     */
     ...
     *
     * @see \MP_Debug_UtilController::enableTranslateAction
     * @return string
     */
     ...
     *
     * @see \MP_Debug_UtilController::disableTranslateAction
     * @return string
     */
     ...
     *
     * @see \MP_Debug_ConfigController::phpinfoAction
     * @return string
     */
     ...
     *
     * @see \MP_Debug_ConfigController::searchAction
     ...
     *
     * @see \MP_Debug_ConfigController::downloadAction
     * @param string $type
     * @return string
     */
     ...
     *
     * @see \MP_Debug_ConfigController::enableVarienProfilerAction
     * @return string
     */
     ...
     *
     * @see \MP_Debug_ConfigController::disableVarienProfilerAction
     * @return string
     */
     ...
     *
     * @see \MP_Debug_EmailController::getBodyAction
     * @param string $token
     * @param int $row
     * @return string
     */
